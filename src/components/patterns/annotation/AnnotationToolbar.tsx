...
const AnnotationToolbar: React.FC<AnnotationToolbarProps> = ({
  ...
  const handleToolClick = (toolType: AnnotationToolType) => {
    ...
    if (toolType === activeToolType) {
      ...
      showSuccess(`${toolType} tool deactivated`);
    } else {
      setActiveToolType(toolType);
      showSuccess(`${toolType} tool activated`);
    }
  };
  ...
  return (
    <ErrorBoundary>
      <div className='flex flex-wrap items-center bg-stone-100 border-b border-stone-200 p-1 space-x-1'>
        ...
        <div className='flex flex-wrap items-center space-x-1 border-l border-stone-300 pl-2'>
          <button
          ...
          <button
            ...
            disabled={disabled}
            aria-label='Add measurement annotation'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              className='h-5 w-5'
          ...
          <button
            ...
            disabled={disabled}
            aria-label='Add highlight annotation'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              className='h-5 w-5'
        ...
        <div className='flex items-center'>
          ...
          <button
            ...
            className={`p-1 rounded transition-colors text-stone-500 hover:text-red-600 hover:bg-stone-200 ${
