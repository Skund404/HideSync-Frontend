...
import { hardwareMaterials } from '../../../services/mock/hardware';
...
const HardwareView: React.FC<HardwareViewProps> = ({ onAdd }) => {
  const {
    viewMode,
    searchQuery,
    filterType,
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      setTimeout(() => {
        setMaterials(hardwareMaterials);
        setLoading(false);
      }, 500);
    };
